...
Floribot_wiimote::Floribot_wiimote(ros::NodeHandle n) : n_(n)
{
	...
	task1_cmd_vel_sub = n_.subscribe("task1_cmd_vel", 1,
			&Floribot_wiimote::task1_cmd_vel_message, this);
...
/**
 * process messages from topic task1_cmd_vel
 *
 * @generated
 */
void Floribot_wiimote::task1_cmd_vel_message (const geometry_msgs::Twist::ConstPtr& msg)
{
